...
class AccessLogView extends StatefulWidget {
  const AccessLogView({super.key});

  @override
  State<AccessLogView> createState() => _AccessLogsViewState();
}

class _AccessLogsViewState extends State<AccessLogView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CommonAppBar(title: 'Access Log'),
      body: Container(
