...
class IpduView extends StatefulWidget {
  const IpduView({super.key});

  @override
  State<IpduView> createState() => _IpduViewState();
}

class _IpduViewState extends State<IpduView> {
  final List<Map<String, String>> Ipdu = [
    {
      'IP': '10.0.3.17',
      'Host Name': 'NM1BMSVM2',
      'CPU': '0.65%',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CommonAppBar(title: 'Ipdu'),
      body: Container(
        ...
        child: ListView.builder(
          itemCount: Ipdu.length,
          itemBuilder: (context, index) {
            final alert = Ipdu[index];
